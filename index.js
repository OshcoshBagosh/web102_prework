...
const displayString = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. Currently, ${unfundedGames} game${
    unfundedGames === 1 ? "" : "s"
...
firstGameContainer.innerHTML = top1.name;
secondGameContainer.innerHTML = top2.name;
